...
export default function Sidebar({ isOpen, toggleSidebar }) {
    return (
        <aside className={`${isOpen ? 'w-50' : 'w-20'} transition-all duration-500 text-white bg-gray-900 p-4`}>
            
            
            <nav className="flex flex-col gap-3">
                <Link to="/" className="flex items-center gap-2 hover:bg-gray-500 p-2 rounded">
                    <Home  />
